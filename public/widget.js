(function () {
  ...
  style.textContent =
    ...
    'background:' +
    accent +
    ';color:#fff;border:none;cursor:pointer;box-shadow:0 4px 16px rgba(0,0,0,.25);' +
    ...
    '.msg.customer{align-self:flex-end;background:' +
    accent +
    ';color:#fff;}' +
    ...
    '.inputRow button{border:none;background:' +
    accent +
    ';color:#fff;padding:0 16px;cursor:pointer;font-size:13px;font-weight:600;}' +
